...
class Installation(object):
	...
	def link(self):
		...
		if self.link not in self.bashrc.data:
			self.bashrc.data += f"\n\n# DevOS:\n{self.link}\n"
			self.bashrc.save()
		return Response.success(f"Successfully linked {ALIAS}.")
	def unlink(self):
		self.bashrc.load()
		...
		return Response.success(f"Successfully unlinked {ALIAS}.")
	def install(self):
	...
	def uninstall(self):
		...
		return Response.success(f"Successfully uninstalled {ALIAS}.")
	# system functions.
